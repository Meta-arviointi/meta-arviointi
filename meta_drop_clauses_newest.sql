...
ALTER TABLE ONLY public.course_memberships DROP CONSTRAINT course_memberships_group_id_fkey;
...
ALTER TABLE ONLY public.action_email_templates DROP CONSTRAINT action_email_templates_action_type_id_fkey;
...
ALTER TABLE ONLY public.action_email_templates DROP CONSTRAINT action_email_templates_pkey;
...
ALTER TABLE public.action_email_templates ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public.action_email_templates_id_seq;
DROP TABLE public.action_email_templates;
